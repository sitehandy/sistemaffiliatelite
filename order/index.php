...
// Get product product
$result = mysql_query("SELECT * FROM produk WHERE idproduk = '2'", $database_connection) or die ('Database Connection Error');
...
<title>Online Group Coaching Bisnes Ebook</title>
</head>
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="http://onlinecoaching.cikguhafis.com">Utama <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
...
<div class="jumbotron">
    <div class="container">
        <h3 class="text-center">Tempahan Online Group Coaching Bisnes Ebook</h3>
        ...
        <div class="col-md-8 offset-md-2">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <tbody>
                        <tr>
                            <td>Online Group Coaching Bisnes Ebook</td>
                            <td>1</td>
