...
function buildLeadIndex($qty, $salesPage) {
	if($qty > $salesPage) {
		...
		$start = 0;
		while($qty > 0) {
			echo "[<a href=\"pwjafflite_member_sales.php?start=".$start."\">".++$index."</a>] ";
			$qty = $qty - $salesPage;
...
if (mysql_num_rows($result) > 0)
{
    ...
    print "<tr><td colspan=\"3\" class=\"SA_general_table_header\">".AFF_MA_MEMBERSALESTOTALTITLE2." - <b><u>";
    ...
    print "<td class=\"SA_details_table_header\">".AFF_G_STATUSPELANGGAN."</td></tr>";
