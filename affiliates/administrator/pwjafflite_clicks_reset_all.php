...
if (($_REQUEST['reset'] == 'allclicksrecords') && ($_REQUEST['validation'] == $_SESSION['aff_valid_admin']))
{
    ...
    if($_POST['commited'] == 'yes')
    {
        ...
        if($errorMsg == '')
        {
            mysql_query("DELETE FROM clickthroughs", $database_connection) or die("Clicks Reset Error");
    ...
    <br />
        <form action="pwjafflite_clicks_reset_all.php?reset=allclicksrecords&validation=<?=$_SESSION['aff_valid_admin']?>" method="post" ENCTYPE="multipart/form-data">
            <div align="center">
                <table cellspacing="1" class="SA_adminarea_statisticbox">
                    <tr>
                        <td colspan="3" class="SA_adminarea_statisticbox_header"><?=AFF_A_CLICKRESET?></td>
                    </tr>
                    <tr>
                        <td colspan="3" class="SA_adminarea_statisticbox_row1">
                            <br /><div align="justfy"><?=AFF_A_CLICKRESETCONFIRM?></div><br /><br />
