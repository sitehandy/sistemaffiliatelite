...
if($_POST['commited'] == 'yes')
{
    ...
    if($errorMsg == '')
    {
        $result = mysql_query("UPDATE produk SET namaproduk = '".$_POST['namaproduk']."', komisyenproduk = '".$_POST['komisyenproduk']."' WHERE idproduk = '".$_POST['edit']."'", $database_connection) or die ('Database INSERT Error');
...
if (mysql_num_rows($result))
{
    ...
    {
        print '<tr><td colspan="3" class="SA_adminarea_statisticbox_header">'.AFF_PT_ADMINPRODUCTCOMMISSIONEDIT.' - '.$_GET['edit'].'</td></tr><tr><td colspan="3" class="SA_adminarea_statisticbox_row1"><br /></td></tr><tr><td class="SA_adminarea_statisticbox_row2"><div align="right">'.AFF_PT_ADMINPRODUCTSNAME.'</div></td><td  class="SA_adminarea_statisticbox_row2"><div align="center">:</div></td><td class="SA_adminarea_statisticbox_row2"><input type="text" name="namaproduk" size="60" value="'.$qry['namaproduk'].'"><br />
        <font color="#FF0000">'.AFF_PT_ADMINPRODUCTSNAMESAMPLE.'</font></td></tr><tr><td class="SA_adminarea_statisticbox_row1"><div align="right">'.AFF_PT_ADMINPRODUCTCOMMISSION.'</div></td><td class="SA_adminarea_statisticbox_row1"><div align="center">:</div></td><td class="SA_adminarea_statisticbox_row1"><input type="text" name="komisyenproduk" size="20" value="'.$qry[komisyenproduk].'"><br /><font color="#FF0000">'.AFF_PT_ADMINPRODUCTCOMMISSIONWARNING.'</font></td></tr><tr><td colspan="3" class="SA_adminarea_statisticbox_row2">&nbsp;</td></tr>';
    }
